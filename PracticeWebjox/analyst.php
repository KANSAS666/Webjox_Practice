...
<style>
 ...
 h4, label{
    ...
    <nav class="navbar navbar-expand-lg brown_panel" style="background: #b5862b;">
        <a class="navbar-brand" href="#">Личный кабинет аналитика</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-4">
            <li class="nav-item">
                <a class="nav-link" href="equipment.php">Музыкальное оборудования</a>
            </li>
            <li class="nav-item">
